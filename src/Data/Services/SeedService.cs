  ...
  private static async Task SeedProducts(ApplicationDbContext context, IEnumerable<Licence> licences, IEnumerable<Comment> comments) {
    List<Product> products = [
      ...
      new() {
        ...
        Description = "Kai ist ein junger, entschlossener Krieger mit scharfem Blick und einem tiefen inneren Antrieb. Mit seinen weissen, zerzausten Haaren und den charakteristischen Narben auf den Wangen verkörpert er sowohl die Stärke als auch die Verletzlichkeit seiner Reise. Sein Outfit, bestehend aus einer wetterfesten Jacke und einem Hoodie, zeigt, dass er bereit ist, sich jeder Herausforderung zu stellen, die auf ihn zukommt.",
      ...
      new () {
        ...
        Description = "Grischak ist ein gefallener Engel, der in dunkle Rüstungen gehüllt und mit mächtigen schwarzen Flügeln ausgestattet ist. Seine Erscheinung ist sowohl furchteinflössend als auch majestätisch, mit einer Mischung aus göttlicher Anmut und unbändiger Kraft. Die schweren Ketten und die kunstvoll gestaltete Rüstung erzählen von Kämpfen und einem schicksalhaften Fall aus dem Himmel. Sein intensiver Blick und die lodernden Flammen im Hintergrund verstärken seine unerschütterliche Entschlossenheit und die dunkle Macht, die er beherrscht.",
      ...
      new () {
        ...
        Description = "Lila ist eine zarte, aber mächtige Kriegerin, die ihre eleganten Blumenmuster und die weisse Rüstung mit einer majestätischen Klinge kombiniert. Ihre violetten Augen und das dunkle, blau getönte Haar verleihen ihr ein geheimnisvolles Aussehen. Die grossen, weissen Blüten, die ihre Kleidung zieren, spiegeln ihre Verbindung zur Natur wider und kontrastieren mit der Schärfe ihrer beeindruckenden Waffe. Inmitten eines Meeres von Blütenblättern wirkt sie gleichzeitig sanft und unaufhaltsam, bereit, ihre Kräfte für den Schutz der Schönheit und des Friedens einzusetzen.",
